    ...
    useEffect(() => {
      ...
      const handleScroll = () => {
        ...
        if (currentScrollY > lastScrollY.current) {
          // Scrolling down
          setRow1Translate((prev) => prev + 5); // Move row 1 to the right
          setRow2Translate((prev) => prev - 5); // Move row 2 to the left
        } else if (currentScrollY < lastScrollY.current) {
          // Scrolling up
          setRow1Translate((prev) => prev - 5); // Move row 1 to the left
          setRow2Translate((prev) => prev + 5); // Move row 2 to the right
        }
  ...
  return (
    ...
    ref={sectionRef}>
      ...
      <div className="overflow-x-hidden mt-8">
        ...
        style={{ translate: '-510px' ,
          transform: `translateX(${row1Translate}px)`,
        transition:'transform 1s ease-out' }}>
        {/* transition:'transform ease linear'}}> */}
            
        <div className="max-w-[7rem] max-h-[7.3rem] lg:max-w-[8.2rem] lg:max-h-[8.5rem] border border-gray shadow-sm rounded-xl p-7 lg:p-9 flex flex-col justify-center items-center ">
        <img src={image1} alt=""/>
        <p className="text-center font-bold mt-2 text-sm leading-tight w-max">Morgon</p>
        </div>

        <div className="max-w-[7rem] max-h-[7.3rem] lg:max-w-[8.2rem] lg:max-h-[8.5rem] border border-gray shadow-sm rounded-xl p-7 lg:p-9 flex flex-col justify-center items-center ">
        <img src={image2} alt="" />
        <p className="text-center font-bold mt-2 text-sm leading-tight w-max">Covy</p>
        </div>

        <div className="max-w-[7rem] max-h-[7.3rem] lg:max-w-[8.2rem] lg:max-h-[8.5rem] border border-gray shadow-sm rounded-xl p-7 lg:p-9 flex flex-col justify-center items-center ">
        <img src={image3} alt="" />
        <p className="text-center font-bold mt-2  text-sm leading-tight w-max">Sunsama</p>
        </div>

        <div className="max-w-[7rem] max-h-[7.3rem] lg:max-w-[8.2rem] lg:max-h-[8.5em] border border-gray shadow-sm rounded-xl p-7 lg:p-9 flex flex-col justify-center items-center ">
        <img src={image4} alt="" />
        <p className="text-center font-bold mt-2  text-sm leading-tight w-max">Campsite</p>
        </div>

        <div className="max-w-[7rem] max-h-[7.3rem] lg:max-w-[8.2rem] lg:max-h-[8.5em] border border-gray shadow-sm rounded-xl p-7 lg:p-9 flex flex-col justify-center items-center ">
        <img src={image5} alt="" />
        <p className="text-center font-bold mt-2  text-sm leading-tight w-max">Rise</p>
        </div>

        <div className="max-w-[7rem] max-h-[7.3rem] lg:max-w-[8.5rem] lg:max-h-[8.5em] border border-gray shadow-sm rounded-xl p-7 lg:p-9 flex flex-col justify-center items-center ">
        <img src={image6} alt="" />
        <p className="text-center font-bold mt-2 text-sm  leading-tight w-max">ClickUp</p>
        </div>

        <div className="max-w-[7rem] max-h-[7.3rem] lg:max-w-[8.2rem] lg:max-h-[8.5rem] border border-gray shadow-sm rounded-xl p-7 lg:p-9 flex flex-col justify-center items-center ">
        <img src={image7} alt="" />
        <p className="text-center font-bold mt-2 text-sm leading-tight w-max">Cursor</p>
        </div>

        <div className="max-w-[7rem] max-h-[7.3rem] lg:max-w-[8.2rem] lg:max-h-[8.5rem] border border-gray shadow-sm rounded-xl p-7 lg:p-9 flex flex-col justify-center items-center ">
        <img src={image8} alt="" />
        <p className="text-center font-bold mt-2  text-sm leading-tight w-max">Kitemaker</p>
        </div>

        <div className="max-w-[7rem] max-h-[7.3rem] lg:max-w-[8.2rem] lg:max-h-[8.5rem] border border-gray shadow-sm rounded-xl p-7 lg:p-9 flex flex-col justify-center items-center ">
        <img src={image9} alt="" />
        <p className="text-center font-bold mt-2  text-sm leading-tight w-max">Voiceflow</p>

        </div>

        <div className="max-w-[7rem] max-h-[7.3rem] lg:max-w-[8.2rem] lg:max-h-[8.5rem] border border-gray shadow-sm rounded-xl p-7 lg:p-9 flex flex-col justify-center items-center ">
        <img src={image10} alt="" />
        <p className="text-center font-bold mt-2 text-sm leading-tight w-max">Linear</p>
        ...
        <div className="max-w-[7rem] max-h-[7.3rem] lg:max-w-[8.2rem] lg:max-h-[8.5rem] border border-gray shadow-sm rounded-xl p-7 lg:p-9 flex flex-col justify-center items-center ">
        <img src={image27} alt="" />
        <p className="text-center font-bold mt-2  text-sm leading-tight w-max">Notion calender</p>
        </div>
    ...
    {/* transition:'transform ease linear' }}> */}
        ...
        <div className="max-w-[7rem] max-h-[7.3rem] lg:max-w-[8.2rem] lg:max-h-[8.5rem] border border-gray shadow-sm rounded-xl p-7 lg:p-9 flex flex-col justify-center items-center">
        <img src={image14} alt="" />
        <p className="text-center font-bold mt-2  text-sm leading-tight w-max">Moises</p>
        </div>

        <div className="max-w-[7rem] max-h-[7.3rem] lg:max-w-[8.2rem] lg:max-h-[8.5rem] border border-gray shadow-sm rounded-xl p-7 lg:p-9 flex flex-col justify-center items-center">
        <img src={image15} alt="" />
        <p className="text-center font-bold mt-2  text-sm leading-tight w-max">Bases</p>
        </div>

        <div className="max-w-[7rem] max-h-[7.3rem] lg:max-w-[8.2rem] lg:max-h-[8.5rem] border border-gray shadow-sm rounded-xl p-7 lg:p-9 flex flex-col justify-center items-center">
        <img src={image16} alt="" />
        <p className="text-center font-bold mt-2 text-sm leading-tight w-max">Bento</p>
        </div>
        ...
        <div className="max-w-[7rem] max-h-[7.3rem] lg:max-w-[8.2rem] lg:max-h-[8.5rem] border border-gray shadow-sm rounded-xl p-7 lg:p-9 flex flex-col justify-center items-center">
        <img src={image18} alt="" />
        <p className="text-center font-bold mt-2  text-sm leading-tight w-max">Grain</p>
        </div>
        ...
        <div className="max-w-[7rem] max-h-[7.3rem] lg:max-w-[8.2rem] lg:max-h-[8.5rem] border border-gray shadow-sm rounded-xl p-7 lg:p-9 flex flex-col justify-center items-center">
        <img src={image20} alt="" />
        <p className="text-center font-bold mt-2  text-sm leading-tight w-max">Cron</p>
        </div>
        ...
        <div className="max-w-[7rem] max-h-[7.3rem] lg:max-w-[8.2rem] lg:max-h-[8.5rem] border border-gray shadow-sm rounded-xl p-7 lg:p-9 flex flex-col justify-center items-center">
        <img src={image22} alt="" />
        <p className="text-center font-bold mt-2  text-sm leading-tight w-max">Cal</p>
        </div>
        ...
        <div className="max-w-[7rem] max-h-[7.3rem] lg:max-w-[8.2rem] lg:max-h-[8.5rem] border border-gray shadow-sm rounded-xl p-7 lg:p-9 flex flex-col justify-center items-center">
        <img src={image24} alt="" />
        <p className="text-center font-bold mt-2 text-sm leading-tight w-max">Beeper</p>
        </div>

        <div className="max-w-[7rem] max-h-[7.3rem] lg:max-w-[8.2rem] lg:max-h-[8.5rem] border border-gray shadow-sm rounded-xl p-7 lg:p-9 flex flex-col justify-center items-center">
        <img src={image25} alt="" />
        <p className="text-center font-bold mt-2 text-sm leading-tight w-max">Web</p>
        </div>
    ...
    <div className={`sm:hidden flex gap-4 w-max on-transform duration-500 mt-8`}
        ...
        <div className="max-w-[7rem] max-h-[7.3rem] border border-gray shadow-sm rounded-xl p-7 flex flex-col justify-center items-center ">
        <img src={image1} alt="" />
