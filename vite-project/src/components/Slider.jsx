...
function Slider() {
  ...
  return (
    <section className="h-screen bg-[#F2F0FF]" // Add overflow-y-scroll to make it scrollable
    ref={sectionRef}>
        
      <div className="overflow-x-hidden">
        <div className="flex justify-center items-center gap-4">
        <span><img className="w-8 h-8 mt-4 " src={myImage} alt="pointer-image" /></span>
        <p className="text-xl font-semibold uppercase">Apps powered by ToDesktop </p>
        <span className="rotate-x-90 transale-y-4"><img className="w-8 h-8 mt-4" src={myImage} alt="pointer-image" /></span>
        </div>

        {/* Row # 01 */}

        <div className={`hidden md:flex gap-4 sm:w-max on-transform duration-700 transition mt-12`}
        style={{ transform: `translateX(${row1Translate}px)`,
        transition:'transform 1s ease-out' }}>
        {/* transition:'transform ease linear'}}> */}
            
        <div className="max-w-40 max-h-40 border border-gray shadow-sm rounded-xl p-9 flex flex-col justify-center items-center bg-white">
        <img src={image1} alt=""/>
    ...
    {/* ROW # 02 */}
      <div className={`hidden md:flex gap-4 w-max mt-4 on-transform duration-500 overflow-hidden`}
    ...
    <div className={`md:hidden flex gap-4 w-max on-transform duration-500 mt-8`}
        style={{transform: `translateX(${row1Translate}px)`,
        transition:'transform 1s ease-out'}}>
        {/* transition:'transform ease linear'}}> */}
    ...
    <div className={`md:hidden flex gap-4 w-max mt-4 on-transform duration-500 overflow-hidden`}
       style={{ transform: `translateX(${row2Translate}px)`,
      transition:'transform 1s ease-out' }}>
    {/* transition:'transform ease linear' }}> */}

        <div className="max-w-36 max-h-36 border border-gray shadow-sm rounded-xl p-8 flex flex-col justify-center items-center bg-white">
        <img src={image6} alt="" />
        <p className="text-center font-bold mt-2 leading-tight w-max">ClickUp</p>
        </div>
...
{/* --------------------------------------------------- Row # 03 for mobile responsive -------------------------------------------------*/}
    ...
    <div className={`md:hidden flex gap-4 w-max on-transform duration-500 mt-6`}
        style={{transform: `translateX(${row1Translate}px)`,
        transition:'transform 1s ease-out' }}>
        {/* transition:'transform ease linear'}}> */}
        ...
        <div className="max-w-36 max-h-36 border border-gray shadow-sm rounded-xl p-8 flex flex-col justify-center items-center bg-white">
        <img src={image22} alt="" />
        <p className="text-center font-bold mt-2 leading-tight w-max">Notion calender</p>
        </div>
