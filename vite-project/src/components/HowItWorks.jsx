...
function HowItWorks({step, title, description, image, featuresLeft, featuresRight }) {
  ...
  return (
    ...
    <section className="mb-10">
      <div className="lg:flex gap-12 items-center p-6 sm:px-6 sm:p-8 lg:p-12 xl:p-12 lg:pt-14 xl:pt-10 pb-12 lg:pb-28 xl:pb-20 rounded-xl max-w-full bg-[#fafafc] border border-gray">
